...
//			} else {crtPage = 1;}
		...
		/*
		 * System.out.println("==========================================");
		 * System.out.println(startPageBtnNo); System.out.println(endPageBtnNo);
		 * System.out.println(prev); System.out.println(next);
		 */
	...
	// (4)
	public Map<String, Object> getBoardList4(int crtPage, String search) {
		System.out.println("@Service 444");
