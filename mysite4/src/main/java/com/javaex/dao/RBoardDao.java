...
public class RBoardDao {
	...
	public List<BoardVo> boardSelect(String keword) {
		...
		List<BoardVo> boardList = sqlSession.selectList("rboard.boardSelect", keword);
	...
	public BoardVo boardRead(int no) {
		return sqlSession.selectOne("rboard.boardRead", no);
	}
	...
	public void boardInsert(BoardVo boardVo) {
		sqlSession.insert("rboard.boardInsert", boardVo);
	}

	// (4-2) 계층형 게시판 댓글 등록
	public void rboardInsert(BoardVo boardVo) {
		sqlSession.insert("rboard.rboardInsert", boardVo);
	}
