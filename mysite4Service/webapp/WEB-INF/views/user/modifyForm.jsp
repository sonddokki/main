							...
							<form action="modify" method="get">
								...
								<div class="form-group">
									<label class="form-text" for="input-uid">아이디</label> <span
										class="text-large bold">${modifyUser.id}</span>
								</div>
								...
								<div class="form-group">
									<label class="form-text" for="input-pass">패스워드</label> <input
										...
										value="${modifyUser.password}" placeholder="비밀번호를 입력하세요">
								</div>
								...
								<div class="form-group">
									<label class="form-text" for="input-name">이름</label> <input
										...
										value="${modifyUser.name}" placeholder="이름을 입력하세요">
								</div>
								...
								<div class="button-area">
									<button href="${pageContext.request.contextPath}/user/modify"
										type="submit" id="btn-submit">회원정보수정</button>
								</div>
